<?php
    ...
    if(isset($_POST) && !empty($_POST)) {
        ...
        if(isset($_POST['prenom']) && isset($_POST['nom']) && isset($_POST['day']) && isset($_POST['month']) && isset($_POST['year']) && isset($_POST['adresse']) && isset($_POST['identifiant']) && isset($_POST['motdepasse']) && isset($_POST['vaccin'])) {
            ...
            $query = "UPDATE `personne` SET `nom`=?,`prenom`=?,`dateNaissance`=?,`adresse`=?,`role`=?,`identifiant`=?,`motdepasse`=?,`idVaccin`=? WHERE idPersonne = 9";
            ...
            $requestDeleteMaladie = $database->prepare("DELETE FROM `possède` WHERE idPersonne = 9");
    ...
    $requestInfoMembre = $database->prepare("SELECT nom, prenom, dateNaissance, adresse, identifiant, motdepasse, idVaccin FROM `personne` WHERE idPersonne = 9");        
            ...
            <form class="login" method="post">
                ...
                <div>
                    ...
                    <select name="maladie[]" id="maladie" multiple>
                        ...
                        <?php
                            $requestListMaladie = $database->prepare("SELECT idMaladie FROM `possède` WHERE idPersonne = 9 ");     
