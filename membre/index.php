            ...
            ?>
                <li class="return">
                    <a href="../admin/index.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#5b17da" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="selects">
                        <select name="day" id="day" value="<?php echo $infoMembre["prenom"] ?>">
                            ...
                            ?>
                                ...
                                <option value="<?php if ($i < 10) {
                                                ...
                                                echo $i; ?>" <?php if ($infoMembre["dateNaissance"][2] == $i) {
                                                                    echo "selected";
                                                                } ?>><?php echo $i; ?></option>
                        ...
                        <select name="month" id="month" value="<?php echo $infoMembre["prenom"] ?>">
                            ...
                            ?>
                                ...
                                <option value="<?php if ($i < 10) {
                                                ...
                                                echo $i; ?>" <?php if ($infoMembre["dateNaissance"][1] == $i) {
                                                                    echo "selected";
                        ...
                        <select name="year" id="year" value="<?php echo $infoMembre["prenom"] ?>">
                            ...
                            ?>
                                ...
                                <option value="<?php echo $i; ?>" <?php if ($infoMembre["dateNaissance"][0] == $i) {
                                                                        echo "selected";
                                                                    } ?>><?php echo $i; ?></option>
                ...
                <div>
                    ...
                    <select name="vaccin" id="vaccin">
                        ...
                        ?>
                            ...
                            <option value="<?php echo $idVaccin; ?>" <?php if ($infoMembre["vaccin"] == $idVaccin) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $nom; ?></option>
                ...
                <div>
                    ...
                    <select name="maladie[]" id="maladie" multiple>
                        ...
                        ?>
                            ...
                            <option value="<?php echo $idMaladie; ?>" <?php if (in_array($idMaladie, $listMaladie)) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $nom; ?></option>
